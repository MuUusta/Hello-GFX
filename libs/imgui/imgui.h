...
struct ImVec2
{
  ...
  void serialize(Archive& ar, const unsigned version) {
    ar & x & y;  // Simply serialize the data members of Obj
  }
};
...
struct ImVec4
{
    ...
    template<typename Archive>
  void serialize(Archive& ar, const unsigned version) {
    ar & x & y & z & w;  // Simply serialize the data members of Obj
  }
};
...
struct ImGuiStyle
{
  ...
  template<typename Archive>
  void serialize(Archive& ar, const unsigned version) {
    ar & Alpha & WindowRounding & WindowBorderSize & ChildRounding & ChildBorderSize & PopupRounding & PopupBorderSize
    & WindowPadding & WindowPadding & WindowMinSize & WindowMinSize & WindowTitleAlign
    & WindowTitleAlign & FramePadding & FramePadding & ItemSpacing & ItemSpacing
    & ItemInnerSpacing & ItemInnerSpacing & TouchExtraPadding & TouchExtraPadding
    & ButtonTextAlign & ButtonTextAlign & SelectableTextAlign & SelectableTextAlign
    & DisplayWindowPadding & DisplayWindowPadding & DisplaySafeAreaPadding & DisplaySafeAreaPadding
    & FrameRounding & FrameBorderSize & IndentSpacing & ColumnsMinSpacing & ScrollbarSize & ScrollbarRounding
    & GrabMinSize & GrabRounding & TabRounding & TabBorderSize & MouseCursorScale & AntiAliasedLines & CurveTessellationTol & Colors/*.x & v4.y & v4.z & v4.w*/;  // Simply serialize the data members of Obj
  }
};
